...
OsciTooltip::OsciTooltip(OsciChart *chart):
    QGraphicsItem(chart),
    m_chart(chart)
{
}

QRectF OsciTooltip::boundingRect() const
{
...
void OsciTooltip::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    Q_UNUSED(option)
    Q_UNUSED(widget)
    QPainterPath path;
...
void OsciTooltip::setAnchor(QPointF point)
{
    m_anchor = point;
}
